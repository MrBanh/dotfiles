...
return {
  ...
  opts = {
    ...
    -- Optional, completion of wiki links, local markdown links, and tags using cmp
    completion = {
  ...
  config = function(_, opts)
    ...
    set({ 'n', 'v' }, '<leader>nr', '<Cmd>ObsidianBacklinks<CR>', { desc = 'Obsidian find references to current buffer' })
  end,
}
